...
const components = {
  code({node, inline, className, children, ...props}) {
    ...
    return !inline && match ? (
      <SyntaxHighlighter customStyle={{background: '#f5f5f5'}} style={atomOneLight} language={match[1]} PreTag="div" children={String(children).replace(/\n$/, '')} {...props} />
    ) : (
  ...
  return (
    <ForwardRefEditor
      ...
      renderHTML={(text) => <ReactMarkdown 
        ...
        remarkPlugins={[gfm, remarkMath]} children={text}
        />
      }
